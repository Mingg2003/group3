...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference("Recommendation.count") do
      post recommendations_url, params: { recommendation: { price: @recommendation.price, product_id: @recommendation.product_id, productid: @recommendation.productid, quantity: @recommendation.quantity, sale: @recommendation.sale, trending: @recommendation.trending } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { price: @recommendation.price, product_id: @recommendation.product_id, productid: @recommendation.productid, quantity: @recommendation.quantity, sale: @recommendation.sale, trending: @recommendation.trending } }
